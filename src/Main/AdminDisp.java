...
public class AdminDisp extends javax.swing.JFrame {
    public AdminDisp() {
        initComponents();
    ...
    public static void main(String args[]) 
    {
        ...
        {
            java.util.logging.Logger.getLogger(AdminDisp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        java.awt.EventQueue.invokeLater(() -> {
            new AdminDisp().setVisible(true);
        });
    }
    public void  printProducts(ResultSet rs)
    {
        ...
        {
            Logger.getLogger(AdminDisp.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
